 ...
 * UTF-8. Weekday/holiday localization is applied via tools/apply_weekday_locale.php after generation.
 *
...
$LT_CHK_LOWER = 'check' . "\u{2011}" . 'in';
$LT_CHK_DETAILS = $LT_CHK . ' / Reservation Details';
$LT_COMPLETE_CHK = 'Complete ' . $LT_CHK . ' / Reservation';
...
$LT_NOT_COMPLETE_LOWER = 'Your ' . $LT_CHK_LOWER . ' / reservation is not yet complete.';
...
$LT_AND_WORD = [
    'th' => ' และ ', 'tl' => ' at ', 'vi' => ' và ', 'id' => ' dan ', 'ms' => ' dan ',
    'fr' => ' et ', 'de' => ' und ', 'hi' => ' और ', 'ru' => ' и ', 'ar' => ' و ', 'pt' => ' e ',
];
...
foreach ($LT_LANG_META as $code => $meta) {
    ...
    if (isset($html[$LT_NOT_COMPLETE])) {
        $html[$LT_NOT_COMPLETE_LOWER] = $html[$LT_NOT_COMPLETE];
    }
    $html['IFLAG Privacy Policy</a> and <a href="https://www.iflag.co.jp/policy"'] =
        ($html['IFLAG Privacy Policy'] ?? 'IFLAG Privacy Policy')
        . '</a>' . ($LT_AND_WORD[$code] ?? ' and ')
        . '<a href="https://www.iflag.co.jp/policy"';
    $TRANSLATIONS[$code] = [
