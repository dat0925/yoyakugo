...
function Get-StaffConfirmRow($lang) {
@"
                      <div class="row">
...
$langs = @{
    'en' = @{
        flow_old = 'Date & Time'; flow_new = 'Staff & Date & Time'
        staff_h2 = 'Select Staff Member'; no_preference = 'No preference'
        date_h2 = 'Select Date and Time'; date_confirm = 'Date & Time'; staff_label = 'Staff Member'
    ...
    'ko' = @{
        flow_old = '날짜·시간'; flow_new = '담당자·날짜·시간'
        staff_h2 = '담당자 선택'; no_preference = '지정하지 않음'
        date_h2 = '날짜·시간 선택'; date_confirm = '날짜·시간'; staff_label = '담당자'
    ...
    'zh-cn' = @{
        flow_old = '日期与时间'; flow_new = '服务人员·日期与时间'
        staff_h2 = '选择服务人员'; no_preference = '不指定'
        date_h2 = '选择日期与时间'; date_confirm = '日期与时间'; staff_label = '服务人员'
    ...
    'zh-tw' = @{
        flow_old = '日期與時間'; flow_new = '服務人員·日期與時間'
        staff_h2 = '選擇服務人員'; no_preference = '不指定'
        date_h2 = '選擇日期與時間'; date_confirm = '日期與時間'; staff_label = '服務人員'
    ...
    'th' = @{
        flow_old = 'วันที่และเวลา'; flow_new = 'พนักงาน·วันที่และเวลา'
        staff_h2 = 'เลือกพนักงาน'; no_preference = 'ไม่ระบุ'
        date_h2 = 'เลือกวันที่และเวลา'; date_confirm = 'วันที่และเวลา'; staff_label = 'พนักงาน'
    ...
    'vi' = @{
        flow_old = 'Ngày & Giờ'; flow_new = 'Nhân viên & Ngày & Giờ'
        staff_h2 = 'Chọn nhân viên'; no_preference = 'Không chỉ định'
        date_h2 = 'Chọn ngày và giờ'; date_confirm = 'Ngày & Giờ'; staff_label = 'Nhân viên'
    ...
    'id' = @{
        flow_old = 'Tanggal & Waktu'; flow_new = 'Staf & Tanggal & Waktu'
        staff_h2 = 'Pilih Staf'; no_preference = 'Tidak ditentukan'
        date_h2 = 'Pilih Tanggal dan Waktu'; date_confirm = 'Tanggal & Waktu'; staff_label = 'Staf'
    ...
    'ms' = @{
        flow_old = 'Tarikh & Masa'; flow_new = 'Kakitangan & Tarikh & Masa'
        staff_h2 = 'Pilih Kakitangan'; no_preference = 'Tidak dinyatakan'
        date_h2 = 'Pilih Tarikh dan Masa'; date_confirm = 'Tarikh & Masa'; staff_label = 'Kakitangan'
    ...
    'tl' = @{
        flow_old = 'Petsa at Oras'; flow_new = 'Staff at Petsa at Oras'
        staff_h2 = 'Pumili ng Staff'; no_preference = 'Hindi tukuyin'
        date_h2 = 'Pumili ng Petsa at Oras'; date_confirm = 'Petsa at Oras'; staff_label = 'Staff'
    ...
    'pt' = @{
        flow_old = 'Data e hora'; flow_new = 'Profissional e Data e hora'
        staff_h2 = 'Selecionar profissional'; no_preference = 'Sem preferência'
        date_h2 = 'Selecionar data e hora'; date_confirm = 'Data e hora'; staff_label = 'Profissional'
    ...
    'ar' = @{
        flow_old = 'التاريخ والوقت'; flow_new = 'الموظف·التاريخ والوقت'
        staff_h2 = 'اختيار الموظف'; no_preference = 'بدون تحديد'
        date_h2 = 'اختر التاريخ والوقت'; date_confirm = 'التاريخ والوقت'; staff_label = 'الموظف'
    ...
    'ru' = @{
        flow_old = 'Дата и время'; flow_new = 'Сотрудник·Дата и время'
        staff_h2 = 'Выбор сотрудника'; no_preference = 'Не указывать'
        date_h2 = 'Выберите дату и время'; date_confirm = 'Дата и время'; staff_label = 'Сотрудник'
    ...
    'hi' = @{
        flow_old = 'दिनांक और समय'; flow_new = 'कर्मचारी·दिनांक और समय'
        staff_h2 = 'कर्मचारी चुनें'; no_preference = 'निर्दिष्ट नहीं'
        date_h2 = 'दिनांक और समय चुनें'; date_confirm = 'दिनांक और समय'; staff_label = 'कर्मचारी'
    ...
    'de' = @{
        flow_old = 'Datum & Uhrzeit'; flow_new = 'Mitarbeiter & Datum & Uhrzeit'
        staff_h2 = 'Mitarbeiter auswählen'; no_preference = 'Keine Angabe'
        date_h2 = 'Datum und Uhrzeit wählen'; date_confirm = 'Datum & Uhrzeit'; staff_label = 'Mitarbeiter'
    ...
    'fr' = @{
        flow_old = 'Date et heure'; flow_new = 'Praticien·Date et heure'
        staff_h2 = 'Choisir un praticien'; no_preference = 'Sans préférence'
        date_h2 = 'Choisir la date et l''heure'; date_confirm = 'Date et heure'; staff_label = 'Praticien'
...
foreach ($code in $langs.Keys) {
    ...
    $indexPath = Join-Path $Root "index_$code.html"
    if (Test-Path $indexPath) {
        $text = [System.IO.File]::ReadAllText($indexPath, [System.Text.Encoding]::UTF8)
        if ($text -notmatch 'staff_select_wrap') {
            $flowOld = $lang.flow_old
            $flowOldAmp = $flowOld -replace '&', '&amp;'
            $flowNew = $lang.flow_new
            $replaced = $false
            if ($text.Contains("<li>$flowOld</li>")) {
                $text = $text.Replace("<li>$flowOld</li>", "<li>$flowNew</li>", 1)
                $replaced = $true
            } elseif ($text.Contains("<li>$flowOldAmp</li>")) {
                $text = $text.Replace("<li>$flowOldAmp</li>", "<li>$flowNew</li>", 1)
                $replaced = $true
            }
            if (-not $replaced) { Write-Host "  WARN flow not found: index_$code.html" }

            $marker = "            <h2>$($lang.date_h2)</h2>`n"
            if ($text.Contains($marker)) {
                $block = Get-StaffBlock $lang
                $text = $text.Replace($marker, $block + $marker, 1)
                [System.IO.File]::WriteAllText($indexPath, $text, $utf8NoBom)
                Write-Host "  updated index_$code.html"
            } else {
                Write-Host "  WARN date h2 not found: index_$code.html"
            }
        } else {
            Write-Host "  skip index_$code.html (already has staff)"
        }
    }

    foreach ($prefix in @('confirm', 'complete', 'cancel_confirm')) {
        $p = Join-Path $Root "${prefix}_$code.html"
        if (-not (Test-Path $p)) { continue }
        $text = [System.IO.File]::ReadAllText($p, [System.Text.Encoding]::UTF8)
        if ($text.Contains($lang.staff_label) -and $text.Contains('店舗花子')) {
            Write-Host "  skip ${prefix}_$code.html (already has staff)"
            continue
        }
        $dateLabel = [regex]::Escape($lang.date_confirm)
        $pattern = "(?s)(<div class=`"row`">\s*<div class=`"cell cell-1 text-right`">$dateLabel</div>\s*<div class=`"cell cell-2`">[^<]*</div>\s*</div>\s*)"
        $m = [regex]::Match($text, $pattern)
        if ($m.Success) {
            $insertAt = $m.Index + $m.Length
            $row = Get-StaffConfirmRow $lang
            $newText = $text.Substring(0, $insertAt) + $row + $text.Substring($insertAt)
            [System.IO.File]::WriteAllText($p, $newText, $utf8NoBom)
            Write-Host "  updated ${prefix}_$code.html"
        } else {
            Write-Host "  WARN date row not found: ${prefix}_$code.html"
        }
    }
}
